...
public class LastAppointmentActivity extends AppCompatActivity {
    ...
    List<Appointement> list=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_last_appointment);
...
//                    if (Integer.parseInt(current_date[0]) > Integer.parseInt(donors_date[0]) && Integer.parseInt(current_date[1]) >= Integer.parseInt(donors_date[1]) && Integer.parseInt(current_date[2]) >= Integer.parseInt(donors_date[2])) {
                ...
                Cadapter = new CurrentAppointementsAdapter(list, LastAppointmentActivity.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(LastAppointmentActivity.this, DonorsActivity.class));
    }
}
